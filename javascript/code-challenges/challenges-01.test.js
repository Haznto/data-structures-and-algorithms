...
const addOne = (arr) => {
  let arr2 = [];
  arr.forEach(element => arr2.push(element +1));
  return arr2;
};
...
const addExclamation = (arr) => {
  let arr2 = [];
  arr.forEach(element => arr2.push(element+'!'));
  return arr2;
};
...
const allUpperCase = (arr) => {
  let arr2= [];
  arr.forEach(element => arr2.push(element.toUpperCase()));
  return arr2;
};
...
const speaker = (words, callback) => {
  let arr2 = [];
  words.forEach(element => arr2.push(callback(element)));
  return arr2;
};
...
const createList = (availableItems) => {
  let arr = [];
  availableItems.forEach(element => element.available && (arr.push(element.name)));
  return arr;
};
...
const fizzbuzz = (arr) => {
  let arr2 =[];
  arr.forEach(element => element%3===0 && element%5===0? arr2.push('Fizz Buzz'):element%3===0?arr2.push('Fizz'):element%5===0? arr2.push('Buzz'):arr2.push(element));
  return arr2;
};
